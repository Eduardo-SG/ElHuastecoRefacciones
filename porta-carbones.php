					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item active submenu dropdown">
								<a href="category.html" class="nav-link dropdown-toggle" role="button" aria-haspopup="true"
			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="category.php">Categorías<span class="lnr lnr-arrow-right"></span></a>
						<a href="porta-carbones.php">Porta Carbones</a>
		...
		<div class="row">
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<section class="lattest-product-area pb-40 category-list">
					<div class="row">
						<?php
						$QueryProductos=$pdo->prepare("SELECT * FROM `tbl_productos` WHERE categoria_id = 1");
